# Angular Boot Camp example: input-transforms
...
**[StackBlitz for input-transforms](https://stackblitz.io/github/AngularBootCamp/input-transforms)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/input-transforms.git
cd input-transforms
npm install
npm start
```
